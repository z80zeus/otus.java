...
public class ConfigImplDefault implements Config {
     ...
     * Эти данные конфигурационный объект считывает откуда-то извне (конфигурационный файл, БД, сетевое соединение...)
     * Перечисленные здесь данные - для демонстрации работы конфигурационного объекта.
     */
