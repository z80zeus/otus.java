...
public class ProcessorSwap implements Processor {
     ...
     * В данном классе, функция создаёт новое сообщение на основе переданного параметром, за исключением того,
     * что значения полей field11 и field12 переставлены местами.
